Rails.application.routes.draw do
  ...
  get   '/users/:uid/requests/:rid'        => 'requests#show',      :as => 'show_requests'
  get   '/users/:uid/requests/new'         => 'requests#new',       :as => 'new_requests'
  ...
  get    '/translators/requests/:rid'      => 'claims#preview',     :as => 'preview_request'
