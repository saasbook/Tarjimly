requests_seed = [{user_tarjimly_id: 5, from_language: 'English', to_language: 'Arabic', document: 'location_of_file', document_format: 'pdf', deadline: '25-Nov-2019',
                  ...
                  {user_tarjimly_id: 1, from_language: 'Urdu', to_language: 'English', document: 'location_of_file', document_format: 'png', deadline: '15-Nov-2019',
                  ...
                  {user_tarjimly_id: 1, from_language: 'English', to_language: 'Arabic', document: 'location_of_file', document_format: 'pdf', deadline: '01-Jan-2020',
...
claims_seed = [{translator_tarjimly_id: 1, _status: 0, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'pdf', request_id: 1},
               {translator_tarjimly_id: 1, _status: 3, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'text-box', request_id: 5},
               {translator_tarjimly_id: 1, _status: 1, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'pdf', request_id: 2},
               {translator_tarjimly_id: 1, _status: 2, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'jpg', request_id: 3},
               {translator_tarjimly_id: 1, _status: 0, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'pdf', request_id: 4},
               {translator_tarjimly_id: 1, _status: 3, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'pdf', request_id: 6},
               {translator_tarjimly_id: 1, _status: 3, submitted_date: 'N/A', translation_text: 'location_of_file', translation_type: 'pdf', request_id: 7}
]
