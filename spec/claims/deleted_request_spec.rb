...
describe 'Translators dismiss claims deleted by users' do 
    before(:each) do 
        @request1 = Request.create(from_language: 'English', to_language: 'Arabic', description: 'information regarding upcoming doctors appointment', document_format: 'pdf', title: 'Doctor Appointment', deadline: '2019-05-05', user_tarjimly_id: 1)
        @request2 = Request.create(from_language: 'English', to_language: 'Arabic', description: 'information regarding upcoming doctors appointment', document_format: 'pdf', title: 'Visa Application', deadline: '2019-05-05', user_tarjimly_id: 1)
    ...
    it  'should have a link to dismiss deleted requests' do 
        ...
        page.should have_selector(:link_or_button, 'View Claim')
    end 
