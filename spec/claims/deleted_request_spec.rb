...
describe 'Translators dismiss claims deleted by users' do 
    before(:each) do 
        ...
        @claim = Claim.create(translator_tarjimly_id: 1, _status: 3, submitted_date: "Nov-25-2019", translation_format: "text", request_id: @request1_id)
        @claim2 = Claim.create(translator_tarjimly_id: 1, _status: 0, submitted_date: "Nov-25-2019", translation_format: "text", request_id: @request2_id)
        @curr_id = @claim.id
        @curr2_id = @claim2.id
    end
